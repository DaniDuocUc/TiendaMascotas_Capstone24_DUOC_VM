...
export class ECommerceInventoryMockApi
{
    ...
    registerHandlers(): void
    {
        ...
        this._fuseMockApiService
            ...
            .reply(() =>
            {
                // Generate a new step-01-product
                const newProduct = {
                ...
                // Unshift the new step-01-product
        ...
        this._fuseMockApiService
            ...
            .reply(({request}) =>
            {
                // Get the id and step-01-product
                const id = request.body.id;
                const product = cloneDeep(request.body.product);

                // Prepare the updated step-01-product
                let updatedProduct = null;

                // Find the step-01-product and update it
                this._products.forEach((item, index, products) =>
                {
                    if ( item.id === id )
                    {
                        // Update the step-01-product
                        products[index] = assign({}, products[index], product);

                        // Store the updated step-01-product
        ...
        this._fuseMockApiService
            ...
            .reply(({request}) =>
            {
                ...
                // Find the step-01-product and delete it
